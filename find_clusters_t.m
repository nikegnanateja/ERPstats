...
%   University of California, San Diego
 ...
 %% edited to only look at the p values rather than the t vales - G. NIke Gnanateja
 
 function [clust_membership, n_clust]=find_clusters_t(pvals,pthr,chan_hood,thresh_sign)
 
 [n_chan, n_tpt]=size(pvals);
 ...
 chan_matrix=repmat([1:n_chan]',1,n_tpt);
     ...
     above_thresh_ids=find(pvals<=pthr);
